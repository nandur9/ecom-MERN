            ...
            <div className="row">
                <div className="col-md-4">
                    <div className="card card-body">
                            <h3>CREATE A NEW KANBAN´S USER</h3>
                        ...
                        <form onSubmit={this.onSubmit}>
                            ...
                            <div className="form-group">
                            <label htmlFor="formUserTeam">User Team</label>
                ...
                <div className="col-md-4">
                <h3 className='color-white'>User list:</h3>
                <p className='color-white'>To delete an User, press doubleclick on it.</p>
